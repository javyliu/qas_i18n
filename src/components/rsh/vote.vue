  ...
  methods: {
    ...
    submit() {
      ...
      if (notSelected.length > 0) {
        ...
        this.$http
          .post('/rsh_vote', Object.assign({ research_id: this.rsh.rsh_id, game_id: this.rsh_data.game_id, name: this.rsh_data.name, partition: this.rsh_data.partition }, _values))
          .then(res => {
            this.is_error = false;
